...
value_details = [
  ('Team Big Brains Smartdoor', 'A smartdoor that uses latest technological features in machine learning and web serving to improve convenience and quality of life', 'http://comingsoon', '../public/images/project.jpeg')
]
value_team = [
  ('Dong', '128.199.15.251'),
  ('Anwar', '161.35.228.53'),
